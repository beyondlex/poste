...
---
--- For blink.cmp: this module IS the source (blink.cmp calls require("poste_http.http.completion").new())
...
local M = {}
local data = require("poste_http.http.data")
local context_detector = require("poste_http.http.context_detector")
local item_builder = require("poste_http.http.item_builder")
local cache = require("poste_http.http.cache")
local var_collector = require("poste_http.http.var_collector")
