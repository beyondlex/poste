...
| [Formatter Design](./format-design.md) | tree-sitter formatter — Region types, formatting rules (✅ implemented) |
...
> [Variable Resolver Design](../archived/http/variable-resolver.md) — `VarResolver` (✅ implemented, pure Lua)  
